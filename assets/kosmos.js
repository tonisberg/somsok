...
if (personCards.length) {
  const people = {
    kadri:    { name: 'Kadri Pikk',          role: 'Special Designer', phone: '5333 7278', email: 'kadi@ksms.ee',      bio: 'Loovpärit ja visuaalsete ruumide kujundaja, kellel on üle 10 aasta kogemust brändi- ja digitaalse valdkonnas. Töö lähtub ideest, et disain peab olema strateegiast lähtuv ja emotsionaalselt kõnetav.', projects: ['Noblessner Quarter', 'Tallinn Airport Signage', 'Ülemiste City Branding', 'Fahle Park Wayfinding'] },
    mart:     { name: 'Mart Lankaits',        role: 'Special Designer', phone: '5645 6777', email: 'mart@ksms.ee',      bio: 'Ruumidisainer ja strateegiline mõtleja, kelle töö keskmes on inimese kogemus füüsilises keskkonnas. Pikaajaline kogemus nii avalike kui eraruumide kujundamisel.', projects: ['Tallinn Old Town Wayfinding', 'Saarineni maja', 'Valla kvartal', 'Tank Kontor'] },
    kristian: { name: 'Kristian Kiirskeit',   role: 'Special Designer', phone: '5665 6777', email: 'kristian@ksms.ee', bio: 'Kristian on ekspert ruumibrändingu ja visuaalse identiteedi valdkonnas. Tema projektid ühendavad funktsionaalsuse esteetilise keelega, luues terviklikke ruumikogemusi.', projects: ['Ülemiste City', 'Fahle Park', 'Liikumise linna südames', 'Space activation project'] },
    jessica:  { name: 'Jessica Keri',         role: 'Special Designer', phone: '5333 7278', email: 'jessica@ksms.ee',  bio: 'Jessica töötab peamiselt placemaking ja ruumi aktiveerimise projektidega. Tema tugevus on kogukondade kaasamine disainprotsessi ja tähenduslike kohtade loomine.', projects: ['Placemaking Tallinn', 'Temporary spaces 2024', 'Spatial installations', 'Community hub design'] },
    kerdi:    { name: 'Kerdi-Kiia',           role: 'Special Designer', phone: '5665 6777', email: 'kerdi@ksms.ee',    bio: 'Kerdi-Kiia on spetsialiseerunud ajutistele ruumilistele installatsioonidele. Ta ühendab projekteerimisel käelise oskuse ja strateegilise mõtlemise.', projects: ['Temporary Pop-up Tallinn', 'Noblessner installations', 'Seasonal activations', 'Branded environments'] },
    helen:    { name: 'Helen Küppes',         role: 'Special Designer', phone: '5645 6777', email: 'helen@ksms.ee',    bio: 'Helen on kogenud graafilise disaini ja brändistrateegia valdkonnas. Tema töö tugevus peitub visuaalse kommunikatsiooni lihtsuses ja selguses.', projects: ['Spatial Branding 2024', 'Wayfinding systems', 'Brand identity spaces', 'Environmental graphics'] },
    liis:     { name: 'Liis Vainne',          role: 'Special Designer', phone: '5333 7278', email: 'liis@ksms.ee',     bio: 'Liis ühendab disainis looduslikud materjalid ja kaasaegsed ruumilahendused, luues harmoonilisi ja kestlikke keskkondi.', projects: ['Sustainable design 2024', 'Natural material study', 'Interior wayfinding', 'Biophilic spaces'] },
    katerina: { name: 'Katerina Muzikaasar',  role: 'Special Designer', phone: '5665 6777', email: 'katerina@ksms.ee', bio: 'Katerina on multidistsiplinaarne disainer, kelle kogemus ulatub ruumidisainist digitaalsete liidesteni. Tema projektides on alati tugev kontseptuaalne alus.', projects: ['Digital wayfinding', 'Mixed-reality spaces', 'Interactive installations', 'Tech-integrated signage'] },
    kristel:  { name: 'Kristel Loonatija',    role: 'Special Designer', phone: '5645 6777', email: 'kristel@ksms.ee',  bio: 'Kristel on spetsialiseerunud kasutajakesksele disainile ja ruumianalüüsile. Ta toob projektidesse süsteemse lähenemise ja detailse viimistluse.', projects: ['User research 2024', 'Spatial analysis', 'Signage testing', 'Customer journey mapping'] },
    alan:     { name: 'Alan Reiss',           role: 'Special Designer', phone: '5333 7278', email: 'alan@ksms.ee',     bio: 'Alan on kogenud konstruktiivse disaini ja tootmise valdkonnas. Tema tugevus on ideede elluviimine — prototüübist valmis installatsioonini.', projects: ['Production management', 'Large-scale installations', 'Fabrication design', 'Installation supervision'] },
    jaak:     { name: 'Jaak Prejs',           role: 'Special Designer', phone: '5665 6777', email: 'jaak@ksms.ee',     bio: 'Jaak on kogenud projektijuht ja ruumidisainer, kelle töö hõlmab nii avalikke ruume kui ka erasektori tellimusprojekte Eestis ja välismaal.', projects: ['International projects', 'Project management', 'Public space design', 'Client relations'] },
    siim:     { name: 'Siim Tiks',            role: 'Special Designer', phone: '5645 6777', email: 'siim@ksms.ee',     bio: 'Siim ühendab fotograafia ja ruumidisaini, luues projekte, mis räägivad lugu nii visuaalselt kui ruumiliselt. Tema dokumentatsioon on osa disainprotsessist.', projects: ['Visual documentation', 'Photography & space', 'Narrative design', 'Brand storytelling'] },
  };
